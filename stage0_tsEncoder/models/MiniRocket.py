...
class Model(nn.Sequential):
	def __init__(self, configs, num_features=10_000, max_dilations_per_kernel=32, random_state=None, bn=False, fc_dropout=0):
	...
	def fit(self, x_enc, chunksize=None, **kwargs):
		x_mark_enc, x_dec = kwargs['x_mark_enc'], kwargs['x_dec']
		x_mark_dec, mask = kwargs['x_mark_dec'], kwargs['mask']
		self.backbone.fit(x_enc, chunksize=chunksize)