...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, required=False, default='Qformer')
    parser.add_argument('--cfg_path', type=str, default="../configs/stage_1_pretrain.yaml")
    ...
    dataset_list = [
        'CR','CT','EP','ER','FD','HB','JV','LI','NATOPS', \
        'PD','PEMS_SF','RS','SAD','SRS1','SRS2','UWG'
    ]
